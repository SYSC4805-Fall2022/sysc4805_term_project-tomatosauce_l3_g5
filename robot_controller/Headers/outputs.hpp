...
#define OUTPUTS_HPP
#include <string>
enum class Outputs{START_NAVIGATION=0, START_OBSTACLE_AVOIDANCE, START_REROUTE, START_EDGE_DETECTED, TURN_LEFT, TURN_RIGHT, STOP, FORWARD, REROUTE_COMPLETE, OBSTACLE_AVOIDED, EDGE_DETECTED_COMPLETE, NONE, CHOOSE_DIRECTION};
